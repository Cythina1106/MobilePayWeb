...
const mockSites: Site[] = [
  {
    ...
    contactEmail: 'bjcy@example.com',
    manager: '张三',
    createTime: '2024-01-01T00:00:00Z',
    updateTime: '2024-07-25T10:30:00Z',
    lastMaintenanceTime: '2024-07-20T14:00:00Z',
    nextMaintenanceTime: '2024-08-20T14:00:00Z'
  },
  {
    id: 'site_002',
    name: '上海浦东机场T1',
    ...
    contactEmail: 'pdairport@example.com',
    manager: '李四',
    createTime: '2024-01-15T00:00:00Z',
    updateTime: '2024-07-24T16:20:00Z',
    lastMaintenanceTime: '2024-07-15T09:00:00Z',
    nextMaintenanceTime: '2024-08-15T09:00:00Z'
  },
  {
    id: 'site_003',
    name: '广州火车南站',
    ...
    contactEmail: 'gznz@example.com',
    manager: '王五',
    createTime: '2024-02-01T00:00:00Z',
    updateTime: '2024-07-25T08:15:00Z',
    lastMaintenanceTime: '2024-07-25T08:00:00Z',
    nextMaintenanceTime: '2024-08-01T08:00:00Z'
  },
  {
    id: 'site_004',
    name: '深圳万象城购物中心',
    ...
    contactEmail: 'szwxc@example.com',
    manager: '赵六',
    createTime: '2024-03-01T00:00:00Z',
    updateTime: '2024-07-23T12:45:00Z',
    lastMaintenanceTime: '2024-07-10T20:00:00Z',
    nextMaintenanceTime: '2024-08-10T20:00:00Z'
  },
  {
    id: 'site_005',
    name: '成都双流国际机场T2',
    ...
    contactEmail: 'cdsljc@example.com',
    manager: '孙七',
    createTime: '2024-03-15T00:00:00Z',
    updateTime: '2024-07-22T09:30:00Z',
    lastMaintenanceTime: '2024-07-05T11:00:00Z',
    nextMaintenanceTime: '2024-08-05T11:00:00Z'
  },
  {
    id: 'site_006',
    name: '杭州西湖文化广场地铁站',
    ...
    contactEmail: 'hzxhgc@example.com',
    manager: '周八',
    createTime: '2024-04-01T00:00:00Z',
    updateTime: '2024-07-25T15:20:00Z',
    lastMaintenanceTime: '2024-06-30T16:00:00Z',
    nextMaintenanceTime: '2024-09-01T16:00:00Z'
  },
  {
    id: 'site_007',
    name: '南京新街口中央商场',
    ...
    contactEmail: 'njxjk@example.com',
    manager: '吴九',
    createTime: '2024-04-15T00:00:00Z',
    updateTime: '2024-07-20T11:15:00Z',
    lastMaintenanceTime: '2024-07-01T22:00:00Z',
    nextMaintenanceTime: '2024-08-01T22:00:00Z'
  },
  {
    id: 'site_008',
    name: '武汉汉口火车站',
    ...
    contactEmail: 'whhkz@example.com',
    manager: '郑十',
    createTime: '2024-05-01T00:00:00Z',
    updateTime: '2024-07-25T13:40:00Z',
    lastMaintenanceTime: '2024-07-18T03:00:00Z',
    nextMaintenanceTime: '2024-08-18T03:00:00Z'
  }
]
...
// Mock出行数据统计
const mockTravelStatistics: TravelStatistics = {
  totalTrips: 876543,
  activeRoutes: 342,
  totalDistance: 12456789, // 总里程（公里）
  totalPayments: 234567890, // 总支付金额（分）
  paymentMethods: {
    qrCode: 456789, // 二维码支付次数
    nfc: 234567,    // NFC支付次数
    card: 123456,   // 刷卡支付次数
    wallet: 67890   // 电子钱包支付次数
  },
  tripsByTransportType: {
    subway: 345678,  // 地铁出行次数
    bus: 432109,     // 公交出行次数
    taxi: 87654,     // 出租车出行次数
    bike: 43210,     // 共享单车出行次数
    walking: 12345   // 步行支付次数
  },
  popularRoutes: [
    {
      routeId: 'R001',
  ...
  peakHours: [
    { hour: 7, tripCount: 45678, revenue: 9135600 },
    { hour: 8, tripCount: 67890, revenue: 13578000 },
    { hour: 9, tripCount: 54321, revenue: 10864200 },
    { hour: 17, tripCount: 56789, revenue: 11357800 },
    { hour: 18, tripCount: 65432, revenue: 13086400 },
    { hour: 19, tripCount: 43210, revenue: 8642000 },
    { hour: 20, tripCount: 32109, revenue: 6421800 },
    { hour: 21, tripCount: 21098, revenue: 4219600 }
  ],
  dailyTrends: [
    { date: '2024-01-22', tripCount: 123456, revenue: 24691200, averageDistance: 14.2 },
    { date: '2024-01-23', tripCount: 134567, revenue: 26913400, averageDistance: 14.8 },
    { date: '2024-01-24', tripCount: 145678, revenue: 29135600, averageDistance: 15.1 },
    { date: '2024-01-25', tripCount: 156789, revenue: 31357800, averageDistance: 15.6 },
    { date: '2024-01-26', tripCount: 167890, revenue: 33578000, averageDistance: 15.9 },
    { date: '2024-01-27', tripCount: 178901, revenue: 35780200, averageDistance: 16.2 },
    { date: '2024-01-28', tripCount: 189012, revenue: 37802400, averageDistance: 16.5 }
  ],
  cityStats: {
    coverage: 85.6, // 城市覆盖率（百分比）
    activeStations: 486, // 活跃站点数
    totalStations: 567,  // 总站点数
    busRoutes: 245,      // 公交线路数
    subwayLines: 25      // 地铁线路数
  },
  userBehavior: {
    averageTripsPerUser: 23.5,        // 人均出行次数
    averageSpendingPerTrip: 8.75,     // 单次出行平均消费（元）
    frequentUsers: [
      { userId: '1001', username: 'commuter_001', tripCount: 312, totalSpending: 273000 },
      { userId: '1002', username: 'commuter_002', tripCount: 298, totalSpending: 261230 },
      { userId: '1003', username: 'commuter_003', tripCount: 287, totalSpending: 251125 },
      { userId: '1004', username: 'commuter_004', tripCount: 276, totalSpending: 241570 },
      { userId: '1005', username: 'commuter_005', tripCount: 265, totalSpending: 231875 }
    ],
    rushHourUsage: {
      morning: 234567,  // 早高峰使用次数（7-9点）
      evening: 198765,  // 晚高峰使用次数（17-19点）
      offPeak: 443211   // 非高峰使用次数
    }
  }
}
...
export const mockApi = {
  ...
  discount: {
    ...
    getStrategies: async (query: any): Promise<ApiResponse<any>> => {
      ...
      if (strategyType) filtered = filtered.filter(s => s.strategy_type === strategyType || s.strategyType === strategyType)
      if (discountType) filtered = filtered.filter(s => s.discount_type === discountType || s.discountType === discountType)
      if (status) filtered = filtered.filter(s => s.status === status)
      if (keyword) filtered = filtered.filter(s =>
        (s.strategy_name && s.strategy_name.includes(keyword)) ||
        (s.strategyName && s.strategyName.includes(keyword)) ||
    ...
    updateStrategy: async (id: string, data: UpdateDiscountStrategyRequest): Promise<ApiResponse<DiscountStrategy>> => {
      ...
      if (index !== -1) {
        ...
        const updatedStrategy: DiscountStrategy = {
          ...existingStrategy,
          strategy_name: data.strategyName || data.strategy_name || existingStrategy.strategy_name,
          strategy_code: data.strategyCode || data.strategy_code || existingStrategy.strategy_code,
          description: data.description || existingStrategy.description,
          strategy_type: data.strategyType || data.strategy_type || existingStrategy.strategy_type,
          discount_type: data.discountType || data.discount_type || existingStrategy.discount_type,
          discount_rate: data.discountRate || data.discount_rate || existingStrategy.discount_rate,
          discount_amount: data.discountAmount || data.discount_amount || existingStrategy.discount_amount,
          min_amount: data.minAmount || data.min_amount || existingStrategy.min_amount,
          max_discount: data.maxDiscount || data.max_discount || existingStrategy.max_discount,
          target_user_type: data.targetUserType || data.target_user_type || existingStrategy.target_user_type,
          target_cities: data.targetCities || data.target_cities || existingStrategy.target_cities,
          target_sites: data.targetSites || data.target_sites || existingStrategy.target_sites,
          start_time: data.startTime || data.start_time || existingStrategy.start_time,
          end_time: data.endTime || data.end_time || existingStrategy.end_time,
          usage_limit: data.usageLimit || data.usage_limit || existingStrategy.usage_limit,
          user_usage_limit: data.userUsageLimit || data.user_usage_limit || existingStrategy.user_usage_limit,
          ...
          last_modified: new Date().toISOString(),
          // 兼容字段更新
          name: data.strategyName || data.strategy_name || existingStrategy.name,
          target_city: (data.targetCities || data.target_cities)?.[0] || existingStrategy.target_city,
          conditions: {
            ...existingStrategy.conditions,
            min_amount: data.minAmount || data.min_amount || existingStrategy.conditions?.min_amount,
            max_usage: data.usageLimit || data.usage_limit || existingStrategy.conditions?.max_usage
          },
          discount: {
            ...existingStrategy.discount,
            value: data.discountRate || data.discount_rate || data.discountAmount || data.discount_amount || existingStrategy.discount?.value,
            max_discount: data.maxDiscount || data.max_discount || existingStrategy.discount?.max_discount
          }
        }
  ...
  device: {
    getDevices: async (query: DeviceQuery): Promise<ApiResponse<PageResponse<Device>>> => {
      ...
      // 站点筛选 - 支持驼峰格式
      if (query.siteId || query.site_id) {
        const siteId = query.siteId || query.site_id
        filteredDevices = filteredDevices.filter(device => device.site_id === siteId)
      }
      ...
      // 设备类型筛选 - 支持驼峰格式
      if (query.deviceType || query.device_type) {
        const deviceType = query.deviceType || query.device_type
        filteredDevices = filteredDevices.filter(device => device.device_type === deviceType)
      }

      // 固件版本筛选 - 支持驼峰格式
      if (query.firmwareVersion || query.firmware_version) {
        const firmwareVersion = query.firmwareVersion || query.firmware_version
        filteredDevices = filteredDevices.filter(device => device.firmware_version === firmwareVersion)
      }

      // 在线状态筛选 - 支持驼峰格式
      if (query.isOnline !== undefined || query.is_online !== undefined) {
        const isOnline = query.isOnline !== undefined ? query.isOnline : query.is_online
        filteredDevices = filteredDevices.filter(device => device.is_online === isOnline)
      }

      // 时间范围筛选 - 支持驼峰格式
      if (query.startTime || query.start_time) {
        const startTime = query.startTime || query.start_time
        filteredDevices = filteredDevices.filter(device => device.created_time >= startTime!)
      }

      if (query.endTime || query.end_time) {
        const endTime = query.endTime || query.end_time
        filteredDevices = filteredDevices.filter(device => device.created_time <= endTime!)
      }

      // 心跳时间范围筛选 - 支持驼峰格式
      if (query.heartbeatStartTime || query.heartbeat_start_time) {
        const heartbeatStartTime = query.heartbeatStartTime || query.heartbeat_start_time
        filteredDevices = filteredDevices.filter(device => device.last_heartbeat_time >= heartbeatStartTime!)
      }

      if (query.heartbeatEndTime || query.heartbeat_end_time) {
        const heartbeatEndTime = query.heartbeatEndTime || query.heartbeat_end_time
        filteredDevices = filteredDevices.filter(device => device.last_heartbeat_time <= heartbeatEndTime!)
      }

      // 排序 - 支持驼峰格式
      if (query.orderBy || query.order_by) {
        const orderBy = (query.orderBy || query.order_by) as keyof Device
        const orderDirection = (query.orderDirection || query.order_direction) === 'desc' ? -1 : 1
    ...
    createDevice: async (data: CreateDeviceRequest): Promise<ApiResponse<Device>> => {
      ...
      const newDevice: Device = {
        ...
        site_name: mockSites.find(s => s.id === data.site_id)?.name,
        status: 'offline',
        is_online: false,
        last_heartbeat_time: new Date().toISOString(),
        created_time: new Date().toISOString(),
        updated_time: new Date().toISOString(),
        heartbeat_timeout_minutes: 5, // 默认值
    ...
    updateDevice: async (id: string, data: UpdateDeviceRequest): Promise<ApiResponse<Device>> => {
      ...
      // 如果更新了site_id，同时更新site_name
      if (data.site_id) {
        updatedDevice.site_name = mockSites.find(s => s.id === data.site_id)?.name
      }
    ...
    searchDevices: async (keyword: string): Promise<ApiResponse<Device[]>> => {
      ...
      const searchResults = mockDevices.filter(device =>
        device.device_name.toLowerCase().includes(searchKeyword) ||
        device.device_code.toLowerCase().includes(searchKeyword) ||
        device.device_type.toLowerCase().includes(searchKeyword) ||
        ...
        (device.site_name && device.site_name.toLowerCase().includes(searchKeyword)) ||
  ...
  site: {
    ...
    getSites: async (query: any): Promise<ApiResponse<any>> => {
      ...
      if (query.keyword) {
        ...
        filteredSites = filteredSites.filter(site =>
          ...
          site.line_name.toLowerCase().includes(keyword)
        )
      }
      ...
      if (query.line_name) {
        filteredSites = filteredSites.filter(site => site.line_name.includes(query.line_name))
      }
      ...
      if (query.start_time && query.end_time) {
        ...
        filteredSites = filteredSites.filter(site => {
          const createDate = new Date(site.createTime)
    ...
    searchSites: async (keyword: string): Promise<ApiResponse<any[]>> => {
      ...
      const searchResults = mockSites.filter(site =>
        ...
        site.address.toLowerCase().includes(lowerKeyword) ||
        site.city.toLowerCase().includes(lowerKeyword) ||
        site.line_name.toLowerCase().includes(lowerKeyword) ||
    ...
    getLines: async (query?: LineQuery): Promise<ApiResponse<LineListResponse>> => {
      ...
      if (query) {
        ...
        if (query.line_name) {
          filteredLines = filteredLines.filter(line =>
            line.line_name.toLowerCase().includes(query.line_name!.toLowerCase())
          )
        }

        if (query.line_code) {
          filteredLines = filteredLines.filter(line =>
            line.line_code.toLowerCase().includes(query.line_code!.toLowerCase())
          )
        }

        if (query.line_type) {
          filteredLines = filteredLines.filter(line => line.line_type === query.line_type)
        }
