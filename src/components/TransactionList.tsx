      ...
      <div className="transaction-stats">
        ...
        <div className="stat-item">
          ...
          <span className="stat-value success">
            {filteredTransactions.filter(t => t.status === '成功').length}
          </span>
        </div>
        <div className="stat-item">
          <span className="stat-label">失败交易</span>
          <span className="stat-value failed">
            {filteredTransactions.filter(t => t.status === '失败').length}
          </span>
        </div>
        <div className="stat-item">
          <span className="stat-label">处理中</span>
          <span className="stat-value pending">
            {filteredTransactions.filter(t => t.status === '处理中').length}
          </span>
        </div>
      </div>
