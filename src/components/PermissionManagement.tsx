...
const PermissionManagement = () => {
  ...
  const permissions: Permission[] = [
    { id: 'dashboardView', name: '查看仪表盘', description: '可以查看数据概览和统计信息', module: '仪表盘' },
    { id: 'dashboardExport', name: '导出仪表盘数据', description: '可以导出仪表盘数据报表', module: '仪表盘' },
    { id: 'transactionView', name: '查看交易', description: '可以查看所有交易记录', module: '交易管理' },
    { id: 'transactionManage', name: '管理交易', description: '可以处理交易、退款等操作', module: '交易管理' },
    { id: 'transactionExport', name: '导出交易数据', description: '可以导出交易数据报表', module: '交易管理' },
    { id: 'userView', name: '查看用户', description: '可以查看用户信息和列表', module: '用户管理' },
    { id: 'userManage', name: '管理用户', description: '可以冻结、解冻用户账户', module: '用户管理' },
    { id: 'userCreate', name: '创建用户', description: '可以创建新的用户账户', module: '用户管理' },
    { id: 'settingsView', name: '查看设置', description: '可以查看系统设置信息', module: '系统设置' },
    { id: 'settingsManage', name: '管理设置', description: '可以修改系统参数和配置', module: '系统设置' },
    { id: 'permissionView', name: '查看权限', description: '可以查看角色和权限信息', module: '权限管理' },
    { id: 'permissionManage', name: '管理权限', description: '可以分配和修改用户角色权限', module: '权限管理' }
  ]
  ...
  const [roles, setRoles] = useState<Role[]>([
    ...
    },
    {
      ...
      permissions: ['dashboardView', 'transactionView', 'transactionManage', 'userView', 'userManage'],
      userCount: 3
    },
    {
      id: '3',
      ...
      permissions: ['dashboardView', 'transactionView', 'userView'],
      userCount: 5
    }
  ])
